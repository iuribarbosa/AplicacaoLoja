...
@NamedQueries({
    ...
    @NamedQuery(name = "Item2.findByCoditem", query = "SELECT i FROM Item2 i WHERE i.coditem = :coditem"),
    @NamedQuery(name = "Item2.findByCodpeditem", query = "SELECT i FROM Item2 i WHERE i.codpeditem = :codpeditem"),
    @NamedQuery(name = "Item2.findByCodproditem", query = "SELECT i FROM Item2 i WHERE i.codproditem = :codproditem"),
    @NamedQuery(name = "Item2.findByQtditem", query = "SELECT i FROM Item2 i WHERE i.qtditem = :qtditem")})
public class Item2 implements Serializable {
    ...
    public Item2(Integer coditem) {
        this.coditem = coditem;
    }

    public Item2(Integer coditem, int codpeditem, int codproditem, float qtditem) {
        this.coditem = coditem;
    ...
    public String toString() {
        return "Mapeamento.Item2[ coditem=" + coditem + " ]";
    }
